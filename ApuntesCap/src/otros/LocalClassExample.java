...
public class LocalClassExample {
    static String regularExpression = "[^0-9]";//coge todo lo distinto de 0 a 9  ^negacion
    public static void validatePhoneNumber(String phoneNumber1, String phoneNumber2) {
        ...
        class PhoneNumber {
            ...
            PhoneNumber(String phoneNumber){// numberLength = 7;
   ...
   Person person1=new Person("Fred",IsoChronology.INSTANCE.date(1980, 6, 20), Person.Sex.MALE,"fred@example.com");
   Person person2=new Person("Jane",IsoChronology.INSTANCE.date(1990, 7, 15),Person.Sex.FEMALE, "jane@example.com");
   listado.add(person1;)
   listado.add(person2;)
   listado.add(new Person("Maria","Gomez","Cerrato"));
